...
- [ ] **Task 1A.1: Initialize the Git repository and dependency manifests**
...
- [ ] **Task 1A.5: Add source-traceability and parallel-path validation**
...
- [ ] **Task 1B.4: Establish template authoring and licensing sign-off**
...
- [ ] **Task 2D.1: Define typed domain contracts and state transitions**
...
- [ ] **Task 2D.2: Implement secret/tenant redaction and safe event allowlists**
  - **Tooling:** Python, Pydantic, pytest.
...
- [ ] **Task 2D.3: Implement prompt-input and Director-memory safeguards**
...
- [ ] **Task 2D.4: Implement content, IP, wellbeing, and disclosure policy gates**
...
- [ ] **Task 3E.1: Implement tenant-safe context assembly**
  - **Tooling:** Python, Pydantic, pytest.
...
- [ ] **Task 3E.2: Implement and red-team Director, World, Storyteller, Evaluator, and Business prompts/adapters**
